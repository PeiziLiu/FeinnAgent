...
class TestToolRegistration:
    ...
    def test_register_duplicate_overwrites(self):
        """Test registering duplicate tool overwrites silently."""
        ...
        # Second registration overwrites silently (no error)
        register(
            ToolDef(
                name="DuplicateTool",
        ...
        assert _tools["DuplicateTool"].description == "Second registration"
